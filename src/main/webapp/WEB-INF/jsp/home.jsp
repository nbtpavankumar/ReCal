...
<head>
    ...
    <link href="<c:url value="/frontassets/css/layout.css" />" media="screen" rel="stylesheet" />
    <link href="<c:url value="/frontassets/css/fonts.css" />" media="screen" rel="stylesheet" />
    <link rel="stylesheet" href="<c:url value="/frontassets/css/powerange.css" />" />
    <script src="<c:url value="/frontassets/js/jquery-1.7.2.min.js" />">
    </script>
...
<body class="grey_matter cleaned">
    <script src="<c:url value="/frontassets/js/cleand2.js" />"></script>
    <div ng-app="landing" ng-controller="landingCtrl as LandingVM" class="borrower-landing" ringgetnsen-pax>
        <div class="header_new">
            <div class="ringgetnsen_logo">
                <a href="/home">
                    <img src="<c:url value="/frontassets/images/Ringgernsen_logo.png" />">
                </a>
            </div>
            <div class="header_right">
                ...
                <div class="sign_in_button">
                    <a href="/admin/login" class="sign_in_style">Sign in
            </a>
                </div>
            </div>
        </div>
        <main id="fullpageWrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="banner_right">
                                <div class="br_inner">
                                    ...
                                    <div class="brih_sap">
                                        <img src="<c:url value="/frontassets/images/sap_rats.png" />">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="small-10 small-centered medium-8 mediumlarge-10 large-9 columns">
                                            <section class="HIW_illustration">
                                                <img src="<c:url value="/frontassets/images/screeennn.png" />">
                                                <div class="HIW_illustration responsiveScreen">
                                                    <div class="responsiveScreen_inner">
                                                        <img class="HIW_screenshot active" id="HIW_screen-checkRate" data-q='HIW-check-rate-image' src="<c:url value="/frontassets/images/slid_pic1.png" />">
                                                        <img class="HIW_screenshot" id="HIW_screen-chooseTerm" data-q='HIW-choose-terms-image' src="<c:url value="/frontassets/images/slid_pic2.png" />">
                                                        <img class="HIW_screenshot" id="HIW_screen-getFunds" data-q='HIW-get-funds-image' src="<c:url value="/frontassets/images/slid_pic1.png" />">
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="small-10 small-centered medium-8 mediumlarge-9 columns">
                                        <section class="HIW_illustration">
                                            ...
                                            <div class="HIW_illustration responsiveScreen">
                                                <div class="responsiveScreen_inner">
                                                    <img class="HIW_screenshot active" data-q='HIW-flattened-choose-terms-image' src="<c:url value="/frontassets/images/slid_pic1.png" />">
                                                </div>
                                            </div>
                                        </section>
                                    </div>
                                    ...
                                    <div class="ringgetnsen_image-wrapper">
                                        <div class="row">
                                            <div class="small-10 small-centered large-12 columns">
                                                <img src="<c:url value="/frontassets/images/recal_phone.png" />" alt="" class="ringgetnsen_image" data-q="ringgetnsen-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mediumlarge-12 columns show-for-mediumlarge-only">
                                    <img src="<c:url value="/frontassets/images/recal_phone.png" />" alt="" class="ringgetnsen_image" data-q="ringgetnsen-image-mediumlarge">
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="app_box">
                                                <div class="ringgetnsen_app-links-wrapper" style="float:left;">
                                                    <a class="ringgetnsen_app-link" href="https://itunes.apple.com/in/genre/ios/id36?mt=8">
                                                        <img src="<c:url value="/frontassets/images/aap_storee.png" />">
                                                    </a>
                                                    <a class="ringgetnsen_app-link" href="https://play.google.com/store?hl=en">
                                                        <img src="<c:url value="/frontassets/images/google_play.png" />">
                                                    </a>
                                                </div>
                                            </div>
            ...
            <section class="fullpage_section schedule_financing">
                ...
                <div class="sf_content2">
                    <img src="<c:url value="/frontassets/images/ExampleGraphics.png" />">
                </div>
            </section>
            <section class="fullpage_section fullpage_section--footer fp-auto-height">
                <div class="footer_new">
                    <div class="fn_row1">
                        <a href="#">
                            <img src="<c:url value="/frontassets/images/fb_icon1.png" />">
                        </a>
                        <a href="#">
                            <img src="<c:url value="/frontassets/images/twitt_icon.png" />">
                        </a>
                        <a href="#">
                            <img src="<c:url value="/frontassets/images/linked_in_icon.png" />">
                        </a>
                    </div>
    ...
    <script src="<c:url value="/frontassets/js/cleand.js" />">
    </script>
    <script>
    ...
    <script src="<c:url value="/frontassets/js/powerange.min.js" />">
    </script>
    <script type="text/javascript">
        // Basic customization.
