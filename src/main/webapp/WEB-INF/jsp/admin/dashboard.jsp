 ...
 <%@ include file="/WEB-INF/jsp/admin/includes/header1.jsp" %>
    ...
    <div class="content_area">
        <div class="content_inner">
            <div class="content_box_wrap">
                <div class="content_heading"><img src="<c:url value="/adminassets/images/dashboard_icon.png" />"> &nbsp;Dashboard</div>
                <div class="cb_mid">
                    <div class="cdm_box1">
                        <div class="cdm_cont">
                            ...
                            <div class="cdm_data">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblRecentApps">
                                   <tr><td width="100%" align="center"><img src="<c:url value="/adminassets/images/rolling.gif"  />" width="25" height="25"></td></tr>
                                </table>
    ...
    getLoanSummary();
     ...
     <%@ include file="/WEB-INF/jsp/admin/includes/footer1.jsp" %>